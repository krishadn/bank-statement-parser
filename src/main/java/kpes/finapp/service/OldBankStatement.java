...
public class OldBankStatement {
    ...
    private List<OldBankTransaction> summary;
    private List<OldBankTransaction> details;
     ...
     */
    public OldBankStatement(Bank bankAndType, 
                            List<OldBankTransaction> summary, 
        ...
        totalTxnAmount = 0;
        for (OldBankTransaction txn: this.details){
    ...
    public List<OldBankTransaction> getSummary() {
        return summary;
    }

    public List<OldBankTransaction> getDetails() {
        return details;
    }
    ...
    public float getAmountDue(){
        if (bankAndType.equals(Bank.BPICC)) {
            ...
            for (OldBankTransaction txn: summary) {
